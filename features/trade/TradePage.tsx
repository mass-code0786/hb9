  ...
  return (
    <Panel className="space-y-4" data-testid="trade-screen">
      <div className="flex items-center justify-between">
        ...
        <button className="rounded-2xl bg-[#0b1728]/75 p-3" type="button" aria-label="Swap settings"><Settings2 size={18} /></button>
      </div>
      ...
      <div className="rounded-2xl bg-[#0b1728]/60 p-4">
        <div className="mb-2 text-xs text-slate-400">From token</div>
        <Field inputMode="decimal" placeholder="0.00" />
        <Select className="mt-3" defaultValue="BNB"><option>BNB</option><option>USDT</option><option>MATIC</option></Select>
      </div>
      ...
      <div className="rounded-2xl bg-[#0b1728]/60 p-4">
        ...
        <Select className="mt-3" defaultValue="USDT"><option>USDT</option><option>USDC</option><option>BNB</option></Select>
      </div>
      <div className="grid grid-cols-2 gap-3">
        <Field defaultValue="0.5" aria-label="Slippage percent" />
        <div className="rounded-2xl border border-white/10 bg-[#0b1728]/70 px-4 py-3 text-sm text-slate-300">Best route</div>
      </div>
