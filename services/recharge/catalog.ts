import type { RechargeCountry, RechargeOperator, RechargeProduct } from "@/types/wallet";
...
export const rechargeCountries: RechargeCountry[] = worldCountries
  .map((country) => ({
    code: country.cca2,
...
export const rechargeOperators: RechargeOperator[] = [
...
export const rechargeProducts: RechargeProduct[] = [
  ...
  { id: "in-vi-199", operatorId: "in-vi", name: "Vi INR 199", localAmount: 199, localCurrency: "INR", validity: "28 days" },
  { id: "pk-jazz-500", operatorId: "pk-jazz", name: "Jazz PKR 500", localAmount: 500, localCurrency: "PKR", validity: "30 days" },
  { id: "pk-zong-300", operatorId: "pk-zong", name: "Zong PKR 300", localAmount: 300, localCurrency: "PKR", validity: "30 days" },
  { id: "ae-etisalat-20", operatorId: "ae-etisalat", name: "Etisalat AED 20", localAmount: 20, localCurrency: "AED", validity: "Instant top-up" },
  { id: "ae-du-25", operatorId: "ae-du", name: "du AED 25", localAmount: 25, localCurrency: "AED", validity: "Instant top-up" },
...
export const supportedCountryCount = "150+";
