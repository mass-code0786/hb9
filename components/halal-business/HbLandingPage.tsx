...
export function HbLandingPage({ referralCode, onAuthenticated }: HbLandingPageProps) {
  ...
  return (
    <section id="top" className="hb-premium-shell relative isolate -mx-3 min-h-[100dvh] overflow-y-visible overflow-x-hidden px-3 pb-[140px] pt-3 text-white [touch-action:pan-y] sm:-mx-4 sm:px-4 md:-mx-6 md:px-6">
