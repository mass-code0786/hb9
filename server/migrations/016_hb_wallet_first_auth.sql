...
create unique index if not exists idx_hb_users_bitzenx_wallet_lower_unique
  on hb_users (lower(bitzenx_wallet_address))
  where bitzenx_wallet_address is not null;
